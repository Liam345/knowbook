"""
Marketing Strategy endpoints - AI-generated marketing strategy documents.

Educational Note: Marketing strategy generation uses the same agentic loop pattern as PRD:
...
- GET  /projects/<id>/studio/marketing-strategies/<id>/preview  - Preview markdown
- GET  /projects/<id>/studio/marketing-strategies/<id>/download - Download file (md)
- DELETE /projects/<id>/studio/marketing-strategies/<id>     - Delete document
"""
import os
...
def preview_marketing_strategy(project_id: str, job_id: str):
    ...
    try:
        ...
        strategy_dir = Path(get_studio_dir(project_id)) / "marketing_strategies"
        file_path = strategy_dir / markdown_file
